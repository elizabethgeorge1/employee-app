...
import { useGetEmployeeByIdQuery, useGetEmployeeListQuery, useUpdateEmployeeMutation } from "./services/empoyee";
        ...
        <div>
          {empList?.map((item) => (
            <EmpRow 
              ...
              deleteOnClick={()=>deletePost(item.empId)}
              editOnClick={()=>navigate(`/view/${item.empId}`)}
